...
static MouseShortcut mshortcuts[] = {
    ...
    {XK_ANY_MOD, Button4, kscrollup, {.i = 1}},    {XK_ANY_MOD, Button5, kscrolldown, {.i = 1}},
...
static char *copyemoji[] = {
    "/bin/sh", "-c",
    "cat ~/.config/st/emojis.txt | wofi --dmenu -p 'Copy emoji' | awk '{print $1}' | wl-copy", "externalpipe",
    NULL};

// clang-format off
static char *help[] = {
    "/bin/sh", "-c",
    "notify-send  '          ST - CONTROL+SHIFT          ' '\n"
                  "+-= : Zoom        C/V : Copy/Paste    \n"
...
static Shortcut shortcuts[] = {
    ...
    {TERMMOD, XK_H, externalpipe, {.v = help}},
